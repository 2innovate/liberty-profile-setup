...
<server description="JAAS Authentication data">
    ...
    <authData id="db2AuthData" user="db2inst1" password="{aes}AATQAaT99osuR4dyWUovpdZR6+ZvKUInGVk94P1FDrci"></authData>
    ...
    <library id="db2Lib" name="db2Lib" description="Shared library for DB2 JDBC driver">
        <fileset dir="${shared.resource.dir}/jdbc/db2" includes="db2jcc4.jar db2jcc_license_cu.jar"></fileset>
    </library>
